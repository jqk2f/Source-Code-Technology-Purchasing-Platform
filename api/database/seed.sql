...
VALUES
  ...
  (4, 'inquiry:view', '意向查看', 'menu', NULL, '/inquiries', 4, NOW(), NOW()),
  (5, 'customer:view', '客户查看', 'menu', NULL, '/customers', 5, NOW(), NOW());
...
INSERT IGNORE INTO products(
  ...
  delivery_content, purchase_notice, license_desc, status, is_new, is_hot,
  ...
  '适合快速搭建商城、预约、会员等业务原型。', JSON_ARRAY('商品管理','预约管理','会员管理','营销配置'),
  '源码包、数据库脚本、部署文档、使用说明', '源码资料交接方式和授权范围以沟通确认为准。', '允许自用和商用，不允许转卖源码。',
...
INSERT IGNORE INTO services(
  ...
  service_scope, service_process, required_materials, delivery_standard, excluded_content,
